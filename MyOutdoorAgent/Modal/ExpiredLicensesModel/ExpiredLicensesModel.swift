//  ExpiredLicensesModel.swift
//  MyOutdoorAgent
//  Created by CS on 06/09/22.

import Foundation

// MARK: - ExpiredLicensesModel
struct ExpiredLicensesModel : Codable {
    let message : String?
    let model : [ExpiredLicensesModelClass]?
    let statusCode : Int?}

// MARK: - ExpiredLicensesModelClass
struct ExpiredLicensesModelClass : Codable {
    let acres : Float?
    let active : String?
